    ...
    if(@pathinfo($_FILES["file"]["name"], PATHINFO_EXTENSION)
      ...
      if(move_uploaded_file($_FILES["file"]["tmp_name"], $target)) {
        ...
        require_once("../mysql.php");
  	  	...
  	  	$sql = "INSERT INTO products (name, description, image, danger, price) VALUES('".mysqli_real_escape_string($db, htmlentities($_POST["name"]))."', '".
          mysqli_real_escape_string($db, htmlentities($_POST["desc"]))."', '".
          mysqli_real_escape_string($db, "/img/uploads/" . basename($_POST["filename"]))."', '".
          mysqli_real_escape_string($db, $danger)."', '".
