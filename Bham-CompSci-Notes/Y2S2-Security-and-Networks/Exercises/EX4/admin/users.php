<?php
  ...
  // ajax request
  if(isset($_REQUEST['user']['id']) && is_numeric($_REQUEST['user']['id']) && isset($_REQUEST['user']['is_dealer'])) {
	  $sql = "UPDATE users SET is_dealer=".($_REQUEST['is_dealer'] == true ? 1 : 0)." WHERE id=".mysqli_real_escape_string($db, $_REQUEST['id']).";";
